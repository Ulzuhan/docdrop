...
const entera = await fetch(`${BASE}/api/download/${subidaGrande.id}`, { headers: { Range: "bytes=0-" } });
check("y el reintento con Range sigue disponible y tiene que contar", entera.status, 206);
